 ...
 * via [BoardViewModel.move] which uses BunkerParser writer.
 *
...
fun KanbanScreen(
    ...
    KanbanScreenContent(bunker = bunker, viewModel = viewModel, modifier = modifier)
}
...
fun KanbanScreenContent(
    ...
    BunkerTheme {
        val allResources = bunker.domains.flatMap { it.resources }
        val sectionNames = bunker.domains.flatMap { it.sections.map { s -> s.name } }
            .distinct()
            .ifEmpty {
        ...
        Box(
            ...
            Row(
                ...
                // If bunker blank, show placeholder column
...
private fun KanbanColumn(
    section: String,
    resources: List<com.knowledgebunker.model.Resource>,
            ...
            Column(
                ...
                resources.forEach { res ->
                    ...
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .border(1.dp, if (isDragging) Color(0xFF000000) else BunkerBlack)
                            .background(if (isDragging) Color(0xFFEFEFEF) else BunkerWhite)
