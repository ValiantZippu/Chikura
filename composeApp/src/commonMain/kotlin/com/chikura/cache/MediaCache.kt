 ...
 * Stores Hydrated entries to chikuthreads/<id>/.chikura-cache/media.json
 ...
 */
class MediaCache(
    private val chikuthreadId: String,
    private val chikuthreadsRoot: String = FileSystem.homeChikuThreadsPath()
) {
    ...
    private fun cacheFilePath(): String {
        ...
        val root = chikuthreadsRoot.trimEnd('/', '\\')
        return "$root/$chikuthreadId/.chikura-cache/media.json"
    }

    private fun cacheDirPath(): String {
        val root = chikuthreadsRoot.trimEnd('/', '\\')
        return "$root/$chikuthreadId/.chikura-cache"
    }
