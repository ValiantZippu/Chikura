package com.chikura.model

import kotlinx.serialization.Serializable

/**
 * ChikuThread spec model — preserves markdown hierarchy.
 * Task 2: ChikuThread Spec Parser — Markdown AST Preserving Indent
 * ChikuThread = repo, Domain = *.md file (kebab-case), Section = ##, Category = ###/####, Resource = bullet URL/bare ref.
 * Task 7: Serializable for marketplace.json curated index (kebab-case *.md + archive-box/inbox.md exists).
 */
@Serializable
data class ChikuThreadMeta(
    val id: String,
    val name: String,
    val path: String = "",
    // Marketplace optional fields — defaults keep FileChikuThreadDataSource mapping compatible
...
/** Alias for test spec: Json.decodeFromString<Marketplace>(json) where Marketplace == List<ChikuThreadMeta> */
typealias Marketplace = List<ChikuThreadMeta>

data class ChikuThread(
    val id: String,
    val name: String,
