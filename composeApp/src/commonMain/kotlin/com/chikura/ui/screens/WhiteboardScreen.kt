...
import com.chikura.ui.board.WhiteboardEdge
...
fun WhiteboardScreen(
    ...
    WhiteboardScreenContent(
        resources = chikuthread.domains.flatMap { it.resources },
        edges = edges,
...
fun WhiteboardScreenContent(
    ...
    ChikuraTheme {
        ...
        Column(modifier = modifier.background(ChikuraWhite).padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            // Toolbar
            Row(
                modifier = Modifier
                ...
                Box(
                    modifier = Modifier
                        .border(1.dp, ChikuraBlack)
                        .background(if (connectMode) ChikuraBlack else ChikuraWhite)
                    ...
                    Text(
                        ...
                        fontFamily = FontFamily.Monospace,
                        fontSize = 9.sp,
                        color = if (connectMode) ChikuraWhite else ChikuraBlack
                    )
                }
                if (selectedId != null) {
                    Text(
            ...
            BoxWithConstraints(
                ...
                resources.forEach { res ->
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .border(1.dp, if (isSelected) Color(0xFF000000) else ChikuraBlack)
                            .background(if (isSelected) Color(0xFFF0F0F0) else ChikuraWhite)
                            .pointerInput(res.id) {
                ...
                if (resources.isEmpty()) {
                    Box(
                        ...
                        Text(
                            text = "(whiteboard empty — add resources to chikuthread)",
                            fontFamily = FontFamily.Monospace,
                            fontSize = 10.sp,
