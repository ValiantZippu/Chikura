...
/**
 * Build ChikuThread model from parsed resources grouped by section/category.
 * This is a convenience used by future hydrator; not required for Task 2 tests but provided for spec completeness.
 */
fun buildChikuThread(id: String, name: String, markdownByDomain: Map<String, String>): ChikuThread {
    ...
    return ChikuThread(id = id, name = name, domains = domains)
}
